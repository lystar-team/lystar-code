...
export interface AppKeybindings {
	...
	"app.viewport.pageUp": true;
	"app.viewport.pageDown": true;
	"app.viewport.top": true;
	"app.viewport.bottom": true;
...
export const KEYBINDINGS = {
	...
	"app.viewport.pageDown": {
		defaultKeys: "shift+pageDown",
		description: "Scroll conversation down",
	},
	"app.viewport.top": {
		defaultKeys: "ctrl+home",
		description: "Jump to conversation start",
	},
	"app.viewport.bottom": {
		defaultKeys: "ctrl+end",
		description: "Follow latest conversation output",
	},
