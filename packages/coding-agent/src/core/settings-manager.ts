...
export interface RetrySettings {
	...
	baseDelayMs?: number; // default: 1000 (exponential backoff: 1s, 2s, 4s, 8s, 16s)
...
export interface Settings {
	...
	enableInstallTelemetry?: boolean; // Deprecated compatibility field; LYStar never sends install telemetry
	...
	showHardwareCursor?: boolean; // Show terminal cursor while still positioning it for IME (default: true)
...
export class SettingsManager {
	...
	getConfiguredTuiMode(): TuiMode | undefined {
		return this.settings.tuiMode === "regular" || this.settings.tuiMode === "fullscreen"
			? this.settings.tuiMode
			: undefined;
	}
