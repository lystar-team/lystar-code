...
type MessageCreateParamsStreamingWithFallbacks = Omit<MessageCreateParamsStreaming, "fallbacks"> & {
	...
	(async () => {
		...
		try {
			...
			if (nextParams !== undefined) {
				params = {
					...(nextParams as MessageCreateParamsStreaming),
					stream: true,
					fallbacks: Array.isArray((nextParams as MessageCreateParamsStreaming).fallbacks)
						? (nextParams as MessageCreateParamsStreaming).fallbacks
						: undefined,
				} as MessageCreateParamsStreamingWithFallbacks;
			}
