import { Check, ChevronDown, CircleHelp, Clipboard, FileCode2, LoaderCircle, Pencil, Trash2, Wrench } from "lucide-react";
...
function ExtensionActivityCard({
	activity,
}: {
	activity: Extract<ReturnType<typeof toSessionItemViewModel>, { kind: "extension_activity" }>;
}) {
	const statusLabel = {
		running: "运行中",
		completed: "已调用",
