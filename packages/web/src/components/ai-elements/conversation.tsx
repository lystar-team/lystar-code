...
export const Conversation = ({ className, ...props }: ConversationProps) => (
	<StickToBottom
		className={cn("relative min-w-0 w-full flex-1 overflow-x-hidden overflow-y-hidden", className)}
		initial="instant"
		resize="instant"
		role="log"
		{...props}
...
export const ConversationContent = ({ className, scrollClassName, ...props }: ConversationContentProps) => (
	<StickToBottom.Content
		scrollClassName={cn("conversation-scroll min-w-0 max-w-full overflow-auto overscroll-y-contain", scrollClassName)}
