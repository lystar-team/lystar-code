    ...
    if target == "help" {
        app.open_overlay(OverlayState::Detail(DetailOverlay {
            ...
            lines: vec![
                ...
                "/new 新建会话，/clone 复制当前会话，/reload 重新加载资源，/resume 继续会话，/export 导出会话，/import 导入会话，/share 分享会话，/copy 复制 Agent 消息，/name 设置会话名称，/agents 查看和控制 Subagent，/changelog 更新内容，/hotkeys 快捷键，/clipboard 剪贴板，/sessions 会话，/tree 分支树".to_owned(),
