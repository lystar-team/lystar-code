...
> 评估日期：2026-08-08
> 项目基线：Pi `v0.84.1`，LYStar Agent `0.84.1-lystar.6`
...
项目版本以 `packages/coding-agent/package.json` 的 `piConfig` 为事实源：Pi `v0.84.1`、LYStar Agent `0.84.1-lystar.6`。本地维护说明中仍出现的旧版本号不作为本方案基线。
