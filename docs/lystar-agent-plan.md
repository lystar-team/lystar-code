...
>
> 当前上游基线：2026-08-07；Pi `v0.84.1`，commit `53fa77ccd8a279eb87e92294ef3687b03ff80112`；Grok Build commit `6e386420825bd44ae648c63e7c8cba12fcec9401`。
...
Pi `v0.84.1` 已具备以下基础，LYStar 直接复用：
...
- Pi 当前基线：`v0.84.1`，commit `53fa77ccd8a279eb87e92294ef3687b03ff80112`
